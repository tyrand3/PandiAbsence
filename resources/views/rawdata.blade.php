        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4>Data dari mesin absensi
                    <a href="{{ route('absence.export') }}" class="btn btn-success pull-right" style="margin-top: -8px;"  title="Ambil data yang ditampilkan berikut sebagai dokumen Excel">Ekspor data</a>
                    <a onclick="eximForm()" class="btn btn-primary pull-right" style="margin-top: -8px; margin-right: 8px;" title="Import dokumen Excel dari mesin absensi untuk memperbarui database">Tambah data</a>   
                </h4>
            </div>
            <div class="panel-body table-responsive">
                <div class="row" id="date-filter">
                    ...
                    <input type="button" name="search" id="range-search" value="search" class="btn btn-info">
                </div>
